...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-light-gray w3-small" style="margin-left: 2%; margin-right: 2%">
        <h4><i class="fa fa-calendar"></i>&nbsp;&nbsp;Cadastro de Locações</h4>
    </div>
    ...
    <div class="w3-container w3-padding-16" style="margin-left: 2%; margin-right: 2%">
        <button class="w3-btn w3-round w3-border w3-light-blue w3-hover-blue" 
            onclick="window.location.href = 'cad_locacoes_novo.php';">
            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Locação Avulsa&nbsp;&nbsp;
        </button>
        <button class="w3-btn w3-round w3-border w3-light-green w3-hover-green" 
            onclick="window.location.href = 'cad_locacoes_novo_mensal.php';">
            <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Locação Mensal
        </button>
    </div>
                ...
                <div class="w3-section w3-center">
                    ...
                    <p>
                        ...
                        <button type="button" class="w3-button w3-round w3-border w3-light-green w3-hover-red" 
                            onclick="Excluir_Registro('cad_locacoes_apagar')">Sim</button>
                    </p>
                    <br />
                </div>
            </form>
