...
<body>
    ...
    <div class="w3-container w3-border w3-round w3-light-gray w3-small" style="margin-left: 2%; margin-right: 2%">
        <h4><i class="fa fa-check"></i>&nbsp;&nbsp;Baixa de Despesa</h4>
    </div>
    <br>
    ...
    <div class="w3-container w3-border w3-round" style="margin-left: 2%; margin-right: 2%">
        <br>
        <form class="form-horizontal" action="model/cad_despesas_service2.php" method="POST">
            <fieldset>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="input_fornec" name="input_fornec" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <input id="input_vencim" name="input_vencim" 
                                class ="form-control" type="date" disabled/>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            onfocus="document.getElementById('input_valor').select();" disabled/>    
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="input_pagam" class="col-md-1 control-label">Data Pagamento:</label>
                        <div class="col-md-2">
                            <input id="input_pagam" name="input_pagam" 
                                class ="form-control" type="date" required/>
                        </div>
                        <label for="input_pago" class="col-md-1 control-label">Valor Pago:</label>
                        <div class="col-md-2">
                            <input id="input_pago" name="input_pago" 
                            class ="form-control" type="number" step="any"
                            onfocus="document.getElementById('input_pago').select();" required/>    
                        </div>
                        <label for="input_forma" class="col-md-1 control-label">Forma de Pagamento:</label>
                        <div class="col-md-2">
                            <select id="input_forma" name="input_forma" class="form-control" required>
    ...
    <script type="text/javascript">
        document.getElementById("input_pagam").focus();
    </script>
