...
<body>
    ...
    <div class="w3-row w3-border w3-round" style="margin-left: 2%; margin-right: 2%">

        <!-- Ficha  -->
        <div class="w3-container" >
            <div class="w3-container" >
                <br>
                <form class="form-horizontal" action="model/cad_clientes_service1.php" method="POST">
                    <fieldset>
